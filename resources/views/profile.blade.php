		...
		<div class="profile-header">
			<div class="row align-items-center">
				...
				<div class="col ml-md-n2 profile-user-info">
					<h4 class="user-name mb-0">Md. Sakul Islam</h4>
					<h6 class="text-muted">shekul.bd201@gmail.com</h6>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="row">
									...
									<p class="col-sm-10">Md. Sakul Islam</p>
								</div>

								<div class="row">
									<p class="col-sm-2 text-muted text-sm-right mb-0 mb-sm-3">Email ID</p>
									<p class="col-sm-10">shekul.bd201@gmail.com</p>
								</div>
